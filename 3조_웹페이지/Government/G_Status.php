...
<html>
  ...
  <body>
    ...
    <div style="width: 70%;height:1000px; padding : 10px; float: left;font-family: 'font_light.otf';">
        ...
        <h5> 접종자의 개인정보, 접종자의 백신 종류, 접종 여부, 모더나/화이자의 1차, 2차, 부스터 샷의 비율(%)에 대한 정보를 포함하고 있습니다.</h5>
        <hr>
        <FORM METHOD="get" ACTION="G_vaccination_ratio_update.php">
          ...
          <INPUT TYPE ="submit" VALUE="Change">
            ...
            <thead>
                <tr>
                    <?php
                    $sql = "desc gov_vaccination_status_ratio ";
            ...
            <tbody>
                <?php
                    $sql = "select * from gov_vaccination_status_ratio";
                    $res = mysqli_query($conn,$sql);
        ...
        <div style="width:50%;float: left">
            <form method="post" action="G_Status.php">
                ssn : <input type = 'text' Name='Name' >
        ...
        <div style="float: left;width : 100%;font-family: 'font_light.otf';font-size : 1.2em;">
            <?php if (isset($_POST['Name']) and $_POST['Name'] != ""): $name = $_POST['Name'];?>
                ...
                <table>
                    <thead>
                        <tr>
                            <?php
                            $sql = "desc gov_vaccination_status_y_n";
                            $res = mysqli_query($conn,$sql);
                            $i = 0;
                            while ($d=mysqli_fetch_array($res)) {
                                echo "<th>" , $d[0] , "</th>";
                    ...
                    <tbody>
                        <?php
                            $sql = "select * from gov_vaccination_status_y_n where ssn='{$name}'";
                            $res = mysqli_query($conn,$sql);
            ...
            <?php unset($_POST);else: ?>
                <table>
                    ...
                    <tbody>
                        <?php
                            $sql = "select * from gov_vaccination_status_y_n";
                            $res = mysqli_query($conn,$sql);
