...
<html>
  ...
  <body>
    ...
    <div style="width: 70%;height:1000px; padding : 10px; float: left;font-family: 'font_light.otf';">
        ...
        <h1> Hospital </h1>
        <h5> 연번, 도시, 병원이름, 병원의 주소, 전화번호, 코로나환자 인원수, 코로나환자 수용가능인원수에 대한 정보를 포함하고 있습니다.</h5>
        <hr>
        <div style="width:30%;float: left">
        <FORM METHOD="get" ACTION="G_hospital_update.php">
            Number : <INPUT TYPE = "text" NAME="Number">
          <INPUT TYPE ="submit" VALUE="Change">
        </FORM>
        </div>
        <div style="width:30%;float: left">
                <form method="post" action="G_Hospital.php">
                    Institution : <input type = 'text' Name='Name' >
        ...
        <?php if (isset($_POST['Name']) and $_POST['Name'] != ""): $name = $_POST['Name'];?>
                ...
                <table>
                    ...
                    <tbody>
                        <?php
                            $sql = "select * from gov_hospital where Institution='{$name}' order by Number asc;";
                            $res = mysqli_query($conn,$sql);
            ...
            <?php unset($_POST);else: ?>
                <table>
                    ...
                    <tbody>
                        <?php
                            $sql = "select * from gov_hospital order by Number asc;";
                            $res = mysqli_query($conn,$sql);
