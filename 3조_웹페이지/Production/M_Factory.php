...
<br>
    ...
    <div style="width: 70%;height:1000px; padding : 10px; float: left;font-family: 'font_light.otf';">
        ...
        <h1> Production Plant </h1>
        <h5> 생산 책임자, 생산 공장의 이름, 주소, 전화번호, 일별 출품량, 일별 생산량, 추가 생성 예정량에 대한 정보를 포함하고 있습니다.</h5>
        <hr>

        <div style="width:50%;float: left">
        <FORM METHOD="get" ACTION="M_factory_update.php">
            production_manager : <INPUT TYPE = "text" NAME="production_manager">
          <INPUT TYPE ="submit" VALUE="Change">
        </FORM>
        </div>
        <div style="width:50%;float: left">
                <form method="post" action="M_Factory.php">
                    production_manager : <input type = 'text' Name='Name' >
        ...
        <?php if (isset($_POST['Name']) and $_POST['Name'] != ""): $name = $_POST['Name'];?>
                ...
                <table>
                    <thead>
                        <tr>
                            <?php
                            $sql = "desc mod_factory_information";
                    ...
                    <tbody>
                        <?php
                            $sql = "select * from mod_factory_information where production_manager='{$name}'";
                            $res = mysqli_query($conn,$sql);
            ...
            <?php unset($_POST);else: ?>
                <table>
                    ...
                    <tbody>
                        <?php
                            $sql = "select * from mod_factory_information";
                            $res = mysqli_query($conn,$sql);
