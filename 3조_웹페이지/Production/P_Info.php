...
<br>
    ...
    <div style="width: 70%;height:1000px; padding : 10px; float: left;font-family: 'font_light.otf';">
        ...
        <FORM METHOD="get" ACTION="P_info_update.php">
        ...
        <?php endif; ?>
        <div style="width:50%;float: left">
                <form method="post" action="P_Info.php">
        ...
        <?php if (isset($_POST['Name']) and $_POST['Name'] != ""): $name = $_POST['Name'];?>
                ...
                <table>
                    <thead>
                        <tr>
                            <?php
                            $sql = "desc pfi_vaccine_information";
                    ...
                    <tbody>
                        <?php
                            $sql = "select * from pfi_vaccine_information where lot_number='{$name}'";
                            $res = mysqli_query($conn,$sql);
            ...
            <?php unset($_POST);else: ?>
                <table>
                    ...
                    <tbody>
                        <?php
                            $sql = "select * from pfi_vaccine_information";
                            $res = mysqli_query($conn,$sql);
