<?php
    ...
    $sql = "SELECT * FROM mod_vaccine_information WHERE lot_number='".$_GET['lot_number']."'";
    ...
    if($ret) {
        ...
        if ($count==0) {
            ...
            echo "<br> <a href='M_Info.php'> <--초기 화면</a> ";
            exit();	
        }		   
    }
    else {
...
<h1> 모더나 백신 정보 수정 </h1>
<FORM METHOD="post"  ACTION="M_info_update_result.php">
