...
<br>
    ...
    <div style="width: 70%;height:1000px; padding : 10px; float: left;font-family: 'font_light.otf';">
        ...
        <FORM METHOD="get" ACTION="P_factory_update.php">
            production_manager : <INPUT TYPE = "text" NAME="production_manager">
          <INPUT TYPE ="submit" VALUE="Change">
        </FORM>
        </div>
        <div style="width:50%;float: left">
                <form method="post" action="P_Factory.php">
        ...
        <?php if (isset($_POST['Name']) and $_POST['Name'] != ""): $name = $_POST['Name'];?>
                ...
                <table>
                    <thead>
                        <tr>
                            <?php
                            $sql = "desc pfi_factory_information";
                    ...
                    <tbody>
                        <?php
                            $sql = "select * from pfi_factory_information where production_manager='{$name}'";
                            $res = mysqli_query($conn,$sql);
            ...
            <?php unset($_POST);else: ?>
                <table>
                    ...
                    <tbody>
                        <?php
                            $sql = "select * from pfi_factory_information";
                            $res = mysqli_query($conn,$sql);
