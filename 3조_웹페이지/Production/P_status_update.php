<?php
    ...
    $sql = "SELECT * FROM pfi_company_quantity WHERE Vaccine_name='".$_GET['Vaccine_name']."'";
    ...
    if($ret) {
        ...
        if ($count==0) {
            ...
            echo "<br> <a href='P_Status.php'> <--초기 화면</a> ";
            exit();
        }
    }
    else {
...
<h1> 화이자 백신 물량 정보 수정 </h1>
<FORM METHOD="post"  ACTION="P_status_update_result.php">
