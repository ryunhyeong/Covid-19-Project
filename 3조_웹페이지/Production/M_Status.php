...
<br>
    ...
    <div style="width: 70%;height:1000px; padding : 10px; float: left;font-family: 'font_light.otf';">
        ...
        <h5> 백신명, 보유량, 금일 수급량, 금일 주문량, 생산계획에 대한 정보를 포함하고 있습니다.</h5>
        <hr>
        <?php if ($_SESSION['userID'] == "Moderna" or $_SESSION['userID'] == "ALL"): ?>
        <div style="width:50%;float: left">
        <FORM METHOD="get" ACTION="M_status_update.php">
            Vaccine_name : <INPUT TYPE = "text" NAME="Vaccine_name">
        ...
        <table>
            ...
            <tbody>
                <?php
                    $sql = "select * from mod_company_quantity";
                    $res = mysqli_query($conn,$sql);
