...
<br>
    ...
    <div style="width: 70%;height:1000px; padding : 10px; float: left">
        <form method="POST" action="M_Insert.php">
            <select name="insertvalue" >
            <option value="mod_company_quantity">Vaccine Status</option>
            <option value="mod_factory_information">Production Factory</option>
            <option value="mod_vaccine_information">Vaccine Info</option>
        </select>
