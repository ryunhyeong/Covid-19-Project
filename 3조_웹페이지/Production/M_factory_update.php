<?php
    ...
    $sql = "SELECT * FROM mod_factory_information WHERE production_manager='".$_GET['production_manager']."'";
    ...
    if($ret) {
        ...
        if ($count==0) {
            ...
            echo "<br> <a href='M_Factory.php'> <--초기 화면</a> ";
            exit();
        }
    }
    else {
...
<h1> 모더나 백신 생산 공장 정보 수정 </h1>
<FORM METHOD="post"  ACTION="M_factory_update_result.php">
