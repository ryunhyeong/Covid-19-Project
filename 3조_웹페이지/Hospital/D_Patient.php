  ...
  <body>
    ...
    <div style="width: 70%;height:1000px; padding : 10px; float: left;font-family: 'font_light.otf';">
        ...
        <div style="float: left;width:30%">
            <FORM METHOD="get" ACTION="DG_corona_patient_information_update.php">
        ...
        <div style="width:50%;float: left">
            <form method="post" action="D_Patient.php">
            ...
            <?php if (isset($_POST['Name']) and $_POST['Name'] != ""): $name = $_POST['Name'];?>
                ...
                <table>
                    <thead>
                        <tr>
                            <?php
                            $sql = "desc dg_corona_patient_information";
                            $res = mysqli_query($conn,$sql);
                            $i = 0;
                            while ($d=mysqli_fetch_array($res)) {
                                if ($_SESSION['userID'] != "DG" and $_SESSION['userID'] != "ALL"):
                    ...
                    <tbody>
                        <?php
                            ...
                            if ($_SESSION['userID'] != "DG" and $_SESSION['userID'] != "ALL"):
                                $sql = "select ".implode(", ", $c_name)." from dg_corona_patient_information where Pat_name='{$name}'";
                            else:
                                $sql = "select * from dg_corona_patient_information where Pat_name='{$name}'";
                            endif;
                            $res = mysqli_query($conn,$sql);
            ...
            <?php unset($_POST);else: ?>
                <table>
                    ...
                    <tbody>
                        <?php
                            if ($_SESSION['userID'] != "DG" and $_SESSION['userID'] != "ALL"):
                                $sql = "select ".implode(", ", $c_name)." from dg_corona_patient_information ";
                            else:
                                $sql = "select * from dg_corona_patient_information ";
                            endif;
