<?php
   ...
   $sql ="INSERT INTO yn_reservation_system (Myself_or_Agent,Client_name,Reservation_date,Client_ssn,Client_age,Vaccine_type,Client_phone) VALUES ('".$Myself_or_Agent;
   ...
   echo "<br> <a href='Y_main.php'> <--초기 화면</a> ";
?>
