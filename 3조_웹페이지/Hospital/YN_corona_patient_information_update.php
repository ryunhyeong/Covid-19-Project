<?php
    ...
    $sql = "SELECT * FROM yn_corona_patient_information WHERE Pat_num='".$_GET['Pat_num']."'";
    ...
    if($ret) {
        ...
        if ($count==0) {
            ...
            echo "<br> <a href='Y_Patient.php'> <--초기 화면</a> ";
            exit();
        }
    }
    else {
...
<h1> 영대병원 확진자 정보 수정 </h1>
<FORM METHOD="post"  ACTION="YN_corona_patient_information_update_result.php">
