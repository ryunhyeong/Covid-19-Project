<?php
    ...
    $sql = "SELECT * FROM dg_reservation_system WHERE Client_ssn='".$_GET['Client_ssn']."'";
    ...
    if($ret) {
        ...
        if ($count==0) {
            ...
            echo "<br> <a href='D_Reservation.php'> <--초기 화면</a> ";
            exit();
        }
    }
    else {
...
<h1> 예약 정보 수정 </h1>
<FORM METHOD="post"  ACTION="DG_hospital_reservation_update_result.php">
