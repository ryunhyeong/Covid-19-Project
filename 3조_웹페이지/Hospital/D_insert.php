...
<html>
  ...
  <div style="width: 70%;height:1000px; padding : 10px; float: left">
        <form method="POST" action="D_insert.php">
            <select name="insertvalue" >
            <option value="dg_corona_patient_information">Covid19 Patient</option>
            <option value="dg_corona_test_people">Covid19 Cotest People</option>
            <option value="dg_reservation_system">Reservation System</option>
        </select>
