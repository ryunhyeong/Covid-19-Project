  ...
  <body>
    ...
    <div style="width: 70%;height:1000px; padding : 10px; float: left;font-family: 'font_light.otf';">
        ...
        <div style="float: left;width:30%">
            <FORM METHOD="get" ACTION="YN_corona_test_people_update.php">
        ...
        <div style="width:50%;float: left">
            <form method="post" action="Y_Cotest.php">
        ...
        <div style="float: left;width : 100%;font-family: 'font_light.otf';font-size : 1.2em;">
            <?php if (isset($_POST['Name']) and $_POST['Name'] != ""): $name = $_POST['Name'];?>
                ...
                <table>
                    <thead>
                        <tr>
                            <?php
                            $sql = "desc yn_corona_test_people";
                    ...
                    <tbody>
                        <?php
                            $sql = "select * from yn_corona_test_people where Cotest_name='{$name}'";
                            $res = mysqli_query($conn,$sql);
            ...
            <?php unset($_POST);else: ?>
                <table>
                    ...
                    <tbody>
                        <?php
                            $sql = "select * from yn_corona_test_people";
                            $res = mysqli_query($conn,$sql);
