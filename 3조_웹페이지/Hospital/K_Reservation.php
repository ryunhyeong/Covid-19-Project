  ...
  <body>
    ...
    <div style="width: 70%;height:1000px; padding : 10px; float: left;font-family: 'font_light.otf';">
        ...
        <div style="float: left;width:30%">
            <FORM METHOD="get" ACTION="KP_hospital_reservation_update.php">
        ...
        <div style="width:50%;float: left">
            <form method="post" action="K_Reservation.php">
        ...
        <div style="float: left;width : 100%;font-family: 'font_light.otf';font-size : 1.2em;">
            <?php if (isset($_POST['Name']) and $_POST['Name'] != ""): $name = $_POST['Name'];?>
                ...
                <table>
                    <thead>
                        <tr>
                            <?php
                            $sql = "desc kp_reservation_system";
                    ...
                    <tbody>
                        <?php
                            $sql = "select * from kp_reservation_system where Client_name='{$name}'";
                            $res = mysqli_query($conn,$sql);
            ...
            <?php unset($_POST);else: ?>
                <table>
                    ...
                    <tbody>
                        <?php
                            $sql = "select * from kp_reservation_system";
                            $res = mysqli_query($conn,$sql);
