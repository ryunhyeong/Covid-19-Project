<?php
    ...
    $sql = "SELECT * FROM dg_corona_test_people WHERE Cotest_ssn='".$_GET['Cotest_ssn']."'";
    ...
    if($ret) {
        ...
        if ($count==0) {
            ...
            echo "<br> <a href='D_Cotest.php'> <--초기 화면</a> ";
            exit();
        }
    }
    else {
...
<h1> 코로나 검사자 정보 수정 </h1>
<FORM METHOD="post"  ACTION="DG_corona_test_people_update_result.php">
